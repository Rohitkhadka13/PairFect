...
class _CausesScreenState extends State<CausesScreen> {
  final Map<String, List<String>> causesList ={"Causes and communities":
  ["Black Lives Matter","Feminism","Environmentalism",
    "Trans rights","Disability rights", "Reproductive rights","Indigenous rights",
    "Voter rights","Human rights","LGBTQ+ rights",
    "Neurodiversity","Volunteering","End religious hate"]};
...
loadUserCauses();
  ...
  Widget build(BuildContext context) {
   ...
   appBar:    AppBar(
        ...
        title: const Text("Causes and communities", style: TextStyle(color: Colors.black)),
        centerTitle: true,
        leading: IconButton(
